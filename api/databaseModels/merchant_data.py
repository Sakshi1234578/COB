...
class merchant_data(models.Model):
    ...
    loginMasterId = models.ForeignKey('api.login_master', on_delete=models.CASCADE, null=True,
                                      db_column='loginMasterId')
    created_date = models.DateTimeField(null=True)
    modified_date = models.DateTimeField(null=True)
    modified_by = models.IntegerField(null=True)
    status = models.CharField(max_length=50, null=True, default='Not-Filled')
